...
// function header_template all page except login and register
...
function footer_template_auth(){
    echo <<<EOT
        <footer class="text-center footer-auth">
            <a href="https://github.com/hafidhmuhammadakbar" target="_blank">
                &copy; 2023, Real Madrid Management Player. <br>
                Hafidh Muhammad Akbar
            </a>
...
// function header_template login and register
function header_template_auth($title){
    echo <<<EOT
    <!DOCTYPE html>
    <html lang="en">
    <head>
